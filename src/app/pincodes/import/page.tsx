        ...
        <main className="flex-1 p-6 space-y-6">
          ...
          <div className="flex items-start justify-between border-b border-slate-900 pb-5">
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <h1 className="text-2xl font-black text-white tracking-tight">Pincode Serviceability Import</h1>
          ...
          {step === "analyzing" && (
            <div className="flex flex-col items-center justify-center py-20 space-y-6 max-w-md mx-auto text-center">
              ...
              <div className="space-y-2">
                <p className="text-base font-bold text-white">Analyzing Pincode Dataset</p>
