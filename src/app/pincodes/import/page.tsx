          ...
          <div key={step.id} className="flex items-center">
            <div
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[10px] font-black transition-all duration-300 ${
                isCompleted
                  ...
                  : isCurrent
                  ? "bg-royal/20 text-royal border border-royal/40"
            ...
            >
              {isCompleted ? (
                ...
                <span className={`w-3 h-3 rounded-full flex items-center justify-center text-[8px] font-black ${isCurrent ? "bg-royal text-white" : "bg-slate-700 text-slate-500"}`}>
                  {i + 1}
                </span>
              )}
              {step.label}
            ...
            {i < STEPS.length - 1 && (
              <div className={`w-6 h-px mx-1 ${i < stepIndex ? "bg-emerald-500/40" : "bg-slate-800"}`} />
            )}
          </div>
        );
      })}
        ...
        <main className="flex-1 p-6 space-y-6">
          ...
          <div className="flex items-start justify-between border-b border-slate-900 pb-5">
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <h1 className="text-2xl font-black text-white tracking-tight">AI Pincode Engine</h1>
              ...
              <div className="lg:col-span-7 space-y-5">
                <div className="bg-slate-900 rounded-3xl p-8 border border-slate-800 shadow-2xl space-y-6">
                  <div className="flex items-center gap-2 border-b border-slate-800 pb-4">
                    ...
                    <h2 className="text-sm font-black text-white">Upload Spreadsheet</h2>
                  </div>

                  {analyzeError && (
                    <div className="p-4 rounded-xl bg-rose-950/60 border border-rose-800 text-rose-300 text-xs font-semibold flex items-start gap-2">
                      <AlertCircle className="w-4 h-4 text-rose-400 shrink-0 mt-0.5" />
                      <div>
                        <p className="font-extrabold text-rose-400 mb-1">Analysis Failed</p>
                        <p>{analyzeError}</p>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs font-semibold focus:outline-none focus:border-royal transition-colors"
                    >
                      {banks.map((b) => (
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {(["MERGE", "REPLACE"] as const).map((mode) => (
                        ...
                        >
                          <span className={`font-extrabold text-xs ${importType === mode ? (mode === "MERGE" ? "text-royal" : "text-rose-400") : "text-white"}`}>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <div className="flex flex-col items-center gap-3">
                        <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${file ? "bg-emerald-500/20 text-emerald-400" : "bg-royal/20 text-royal"}`}>
                          {file ? <CheckCircle2 className="w-6 h-6" /> : <FileSpreadsheet className="w-6 h-6" />}
                        </div>
                        {file ? (
                          <>
                            <p className="text-sm font-extrabold text-emerald-400">{file.name}</p>
                          ...
                          <>
                            <p className="text-sm font-extrabold text-slate-300">Drop file here or click to browse</p>
              ...
              <div className="lg:col-span-5 space-y-4">
                ...
                <div className="bg-slate-900 rounded-2xl p-5 border border-slate-800 space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-xs font-black text-white uppercase tracking-wider">Security Guarantees</h3>
                  </div>
                  <div className="space-y-2">
                    {[
                      ...
                      <div key={i} className="flex items-start gap-2 text-[10px] text-slate-400 font-medium">
                ...
                <div className="bg-slate-900 rounded-2xl p-5 border border-slate-800 space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-xs font-black text-white uppercase tracking-wider">Supported Formats</h3>
                  </div>
                  <div className="space-y-2">
                    {[
                      ...
                      <div key={i} className="flex items-start gap-2">
                        ...
                        <div className="text-[10px]">
                          <span className="font-black text-slate-300">{f.bank}:</span>{" "}
                ...
                <div className="bg-slate-900 rounded-2xl p-5 border border-slate-800 space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-xs font-black text-white uppercase tracking-wider">How It Works</h3>
                  </div>
                  {["Upload your file", "AI maps column headers", "You review & adjust mapping", "Confirm to import to production"].map((step, i) => (
                    <div key={i} className="flex items-center gap-3">
                      <div className="w-5 h-5 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center text-[9px] font-black text-slate-400 shrink-0">{i + 1}</div>
          ...
          {step === "analyzing" && (
            <div className="flex flex-col items-center justify-center py-24 space-y-8">
              ...
              <div className="text-center space-y-2">
                <h1 className="text-xl font-black text-white tracking-tight">AI Pincode Engine</h1>
                <p className="text-xs text-slate-400 font-semibold mt-0.5">Upload serviceability lists for automatic parsing</p>
            ...
            <>
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-5 space-y-4">
                  ...
                  <div className="bg-slate-900 rounded-2xl p-5 border border-slate-800 space-y-3">
                    <div className="flex items-center gap-2">
                      <FileSpreadsheet className="w-4 h-4 text-blue-400" />
                      <h3 className="text-xs font-black text-white uppercase tracking-wider">File Analysis</h3>
                      {aiMapping?.usedFallback && (
                        <span className="ml-auto px-2 py-0.5 rounded-full text-[9px] font-black bg-amber-500/10 text-amber-400 border border-amber-500/20">
                          Rule-Based
                        </span>
                      )}
                    </div>
                    <div className="grid grid-cols-2 gap-2">
                      {[
                        ...
                        <div key={item.label} className="bg-slate-950/80 rounded-xl p-2.5">
                          <p className="text-[9px] text-slate-500 font-semibold uppercase tracking-wider">{item.label}</p>
                          <p className="text-xs font-extrabold text-white mt-0.5 truncate">{item.value}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="bg-slate-900 rounded-2xl p-5 border border-slate-800 space-y-4">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="text-xs font-black text-white uppercase tracking-wider">Column Mapping</h3>
                    </div>

                    {aiMapping?.usedFallback && (
                      <div className="p-3 rounded-xl bg-amber-950/40 border border-amber-800/40 flex items-start gap-2">
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center justify-between gap-2">
                              ...
                              <div className="flex items-center gap-1.5">
                                {needsReview && suggestedCol && (
                                  <span className="px-1.5 py-0.5 rounded text-[8px] font-black bg-amber-500/10 text-amber-400 border border-amber-500/20">
                                    NEEDS REVIEW
                                  </span>
                                )}
                                {notMapped && field.required && (
                                  <span className="px-1.5 py-0.5 rounded text-[8px] font-black bg-rose-500/10 text-rose-400 border border-rose-500/20">
                                    REQUIRED
                                  </span>
                                )}
                                {suggestedCol && conf > 0 && (
                            ...
                            <select
                              ...
                              className="w-full px-2.5 py-2 rounded-lg bg-slate-900 border border-slate-700 text-white text-[10px] font-semibold focus:outline-none focus:border-royal transition-colors"
                            >
                  ...
                  {(aiMapping?.warnings?.length || 0) > 0 && (
                    <div className="bg-amber-950/30 rounded-2xl p-4 border border-amber-800/40 space-y-2">
                      <div className="flex items-center gap-2">
                        <TriangleAlert className="w-3.5 h-3.5 text-amber-400" />
                        <h4 className="text-[10px] font-black text-amber-400 uppercase tracking-wider">Warnings</h4>
                      </div>
                      <ul className="space-y-1">
                        {aiMapping!.warnings.map((w, i) => (
                          <li key={i} className="text-[10px] text-amber-300/80 font-medium flex items-start gap-1.5">
                  ...
                  <div className="flex gap-3">
                    <button
                      onClick={handleReset}
                      className="px-4 py-2.5 rounded-xl border border-slate-700 text-slate-400 hover:text-white hover:border-slate-600 text-xs font-bold transition-colors flex items-center gap-1.5 cursor-pointer"
                    >
                  ...
                  <div className="bg-slate-900 rounded-2xl border border-slate-800 overflow-hidden h-full flex flex-col">
                    ...
                    <div className="flex items-center justify-between px-5 py-4 border-b border-slate-800 bg-slate-950/50">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="px-2 py-0.5 rounded text-[8px] font-black bg-slate-800 text-slate-500 border border-slate-700">
                          READ-ONLY
                        </span>
                      </div>
                      {/* Status badge */}
                    ...
                    <div className="grid grid-cols-4 divide-x divide-slate-800 border-b border-slate-800">
                      {[
                        { label: "Total Rows", value: analyzeResult.rowCount.toLocaleString(), color: "text-white" },
                        { label: "Valid", value: analyzeResult.validRows.toLocaleString(), color: "text-emerald-400" },
                        { label: "Invalid", value: analyzeResult.invalidRows.toLocaleString(), color: "text-rose-400" },
                        { label: "Duplicates", value: analyzeResult.fileDuplicates.toLocaleString(), color: "text-amber-400" },
                      ].map((stat) => (
                    ...
                    <div className="px-5 py-2.5 border-b border-slate-800 bg-slate-950/30 flex items-center gap-2 flex-wrap">
                    ...
                    {!isMappingReady ? (
                      <div className="flex-1 flex flex-col items-center justify-center py-16 text-center px-6">
                        ...
                        <p className="text-sm font-bold text-slate-500">Pincode column not mapped</p>
                        ...
                        <table className="w-full text-left text-[10px] border-collapse">
                          <thead>
                            <tr className="bg-slate-950 border-b border-slate-800">
                              ...
                              {TARGET_FIELDS.filter((f) => confirmedMapping[f.key]).map((f) => (
                                <th
                                  key={f.key}
                                  className="px-4 py-2.5 text-slate-400 font-black uppercase tracking-wider whitespace-nowrap"
                                >
                                  <div className="flex items-center gap-1">
                                    <span>{f.icon}</span>
                                    {f.label}
                                  </div>
                                  <div className="text-[8px] text-slate-600 font-semibold normal-case tracking-normal mt-0.5">
                          ...
                          <tbody>
                            {previewRows.length === 0 ? (
                              <tr>
                                <td colSpan={99} className="text-center py-8 text-slate-600 font-semibold">
                              ...
                              previewRows.map((row, i) => (
                                <tr
                                  key={i}
                                  className="border-b border-slate-900/80 hover:bg-slate-800/30 transition-colors"
                                >
                                  <td className="px-4 py-2.5 text-slate-600 font-mono">{i + 1}</td>
                                  {TARGET_FIELDS.filter((f) => confirmedMapping[f.key]).map((f) => (
                                    <td key={f.key} className="px-4 py-2.5 font-medium text-slate-300 max-w-[200px] truncate" title={row[f.key]}>
                                      {row[f.key] || <span className="text-slate-700 italic">—</span>}
                                    </td>
                                  ))}
                                </tr>
                              ))
              ...
              {showConfirmModal && (
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                  <div className="bg-slate-900 rounded-3xl border border-slate-700 shadow-2xl w-full max-w-md space-y-6 p-8 animate-slow-fade">
                    <div className="flex items-start justify-between">
                      <div>
                        <h2 className="text-lg font-black text-white">Import Summary</h2>
                        <p className="text-xs text-slate-400 mt-1">Review before writing to production database</p>
                      </div>
                      <button
                    ...
                    <div className="bg-slate-950 rounded-2xl p-4 space-y-3">
                      {[
                        ...
                        { label: "Total Rows", value: analyzeResult.rowCount.toLocaleString() },
                        { label: "Valid Rows", value: analyzeResult.validRows.toLocaleString(), color: "text-emerald-400" },
                        { label: "Invalid / Skip", value: (analyzeResult.invalidRows + analyzeResult.fileDuplicates).toLocaleString(), color: "text-amber-400" },
                        ...
                        <div key={item.label} className="flex items-center justify-between">
                          ...
                          <span className={`text-[10px] font-black ${(item as any).color || "text-white"} max-w-[200px] truncate text-right`}>
                            {item.value}
                          </span>
                        </div>
                      ))}
                    ...
                    {/* Warning */}
                    <div className={`p-4 rounded-xl border flex items-start gap-2 ${importType === "REPLACE" ? "bg-rose-950/60 border-rose-700" : "bg-amber-950/40 border-amber-700/50"}`}>
                      <TriangleAlert className={`w-4 h-4 shrink-0 mt-0.5 ${importType === "REPLACE" ? "text-rose-400" : "text-amber-400"}`} />
                      <div>
                        <p className={`text-xs font-black mb-1 ${importType === "REPLACE" ? "text-rose-400" : "text-amber-400"}`}>
                          {importType === "REPLACE" ? "⚠ REPLACE MODE — All existing records will be deleted" : "This will modify PRODUCTION data"}
                        </p>
                        <p className={`text-[10px] font-medium ${importType === "REPLACE" ? "text-rose-300/70" : "text-amber-300/70"}`}>
                          {importType === "REPLACE"
                    ...
                    <div className="flex gap-3">
                      <button
                        onClick={() => setShowConfirmModal(false)}
                        className="flex-1 h-11 rounded-xl border border-slate-700 text-slate-300 hover:text-white hover:border-slate-600 text-xs font-bold transition-colors cursor-pointer"
                      >
                        Cancel
                      </button>
                      <button
          ...
          {step === "importing" && (
            <div className="flex flex-col items-center justify-center py-20 space-y-10">
              ...
              <div className="flex items-center gap-2">
                {["Validating", "Normalizing", "Importing", "Completing"].map((stage, i) => (
                  <div key={stage} className="flex items-center gap-2">
                    <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-royal/20 border border-royal/30 text-[10px] font-black text-royal">
                      <Loader2 className="w-3 h-3 animate-spin" />
                      {stage}
                    </div>
              ...
              {/* Progress card */}
              <div className="bg-slate-900 rounded-3xl border border-slate-800 p-10 w-full max-w-lg space-y-6 text-center">
                <div>
                ...
                {importStatus && (
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      { label: "Imported", value: importStatus.processedRecords, color: "text-emerald-400" },
                      { label: "Skipped", value: importStatus.skippedRecords ?? 0, color: "text-amber-400" },
                      { label: "Failed", value: importStatus.failedRecords, color: "text-rose-400" },
                    ].map((s) => (
                      <div key={s.label} className="bg-slate-950 rounded-xl p-3">
          ...
          {step === "result" && (
            <div className="flex flex-col items-center justify-center py-16 space-y-6 max-w-2xl mx-auto w-full">
              ...
              {importStatus && (
                <div className="w-full bg-slate-900 rounded-2xl border border-slate-800 overflow-hidden">
                  <div className="grid grid-cols-4 divide-x divide-slate-800">
                    {[
                      { label: "Total", value: importStatus.totalRecords, color: "text-white" },
                      { label: "Imported", value: importStatus.processedRecords, color: "text-emerald-400" },
                      { label: "Skipped", value: importStatus.skippedRecords ?? 0, color: "text-amber-400" },
                      { label: "Failed", value: importStatus.failedRecords, color: "text-rose-400" },
                    ].map((s) => (
              ...
              <div className="flex gap-4">
                <button
                  onClick={handleReset}
                  className="px-6 py-2.5 rounded-xl border border-slate-700 text-slate-300 hover:text-white hover:border-slate-600 text-xs font-bold transition-colors cursor-pointer flex items-center gap-2"
                >
                  <RefreshCw className="w-3.5 h-3.5" />
                  New Import
                </button>
                <a
                  href="/import-history"
                  className="px-6 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-white text-xs font-bold transition-colors flex items-center gap-2"
                >
                  View Import History
                  <ArrowRight className="w-3.5 h-3.5" />
                </a>
